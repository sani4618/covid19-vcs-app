                        ...
                        <div className="row g-3">
                            ...
                            <div className="col col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                                ...
                                <select name="department" id="" className="form-control" >
                                    <option value="select">Select</option>
                                    <option value="covidtracker">COVIDTracer</option>
                                    <option value="bedavailabilityreporter">Bed availabity reporter</option>
                                    <option value="covidstatusupdater">COVID Status updater</option>
                                </select>
                            </div>
